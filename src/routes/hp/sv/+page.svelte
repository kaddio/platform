...
<div class="bg-white">
	...
	<div class="relative isolate overflow-hidden bg-gray-900 pt-14 pb-16 sm:pb-20">
		...
		<div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
			...
			<p class="mt-6 text-lg leading-8 text-gray-300">Det är ett webbaserat allt-i-allo-system för dig som hjälper andra. Enkelt att använda. Du kommera att älska det.</p>
			<div class="mt-10 flex items-center justify-center gap-x-6">
				<a href="/hp/sv/create" class="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400">Läs mer</a>
	...
	<div class="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
	  <div class="relative isolate overflow-hidden bg-gray-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
		...
		<div class="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
		  <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">Boosta din produktivitet.<br>Engagera dina kunder.</h2>
