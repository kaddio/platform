    ...
    <div class="w-full max-w-md space-y-8">
      <div>
        ...
        <p class="mt-2 text-center text-sm text-gray-600">
          Eller
          <a href="/hp/sv/create" class="font-medium text-indigo-600 hover:text-indigo-500">skapa konto</a>
        </p>
      </div>
      <form on:submit|preventDefault={submit} class="mt-8 space-y-6" action="#" method="POST">
        ...
        <div>
            <button type="submit" disabled={!submitIsEnabled} class="disabled:opacity-75 group relative flex w-full justify-center rounded-md bg-indigo-600 py-2 px-3 text-sm font-semibold text-white hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
