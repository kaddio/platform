    ...
    <div class="isolate bg-white py-24 px-6 sm:py-32 lg:px-8">
        ...
        <div class="grid grid-cols-1 gap-y-6 gap-x-8 sm:grid-cols-2">
            ...
            <div class="sm:col-span-2">
                ...
                <div class="mt-2.5">
                    <input type="text" name="url" id="url" class="block w-full rounded-md border-0 py-2 px-3.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
            </div>
