...
<div class="relative isolate overflow-hidden bg-white py-24 sm:py-32">
  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:mx-0">
      <p class="text-lg font-semibold leading-8 tracking-tight text-indigo-600">{$token.firstname} rekommenderar</p>
    ...
    <div class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:mt-10 lg:max-w-none lg:grid-cols-12">
      ...
      <div class="max-w-xl text-base leading-7 text-gray-700 lg:col-span-7">
        ...
        <ul role="list" class="mt-8 max-w-xl space-y-8 text-gray-600">
          ...
          <li class="flex gap-x-3">
            2
            <span><strong class="font-semibold text-gray-900">Pay.</strong> Earn credits upon upon the first payment of your account.</span>
          </li>
          <li class="flex gap-x-3">
            3
        ...
        <div class="mt-8">
          <a href="/hp/sv" class="inline-flex rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Läs mer</a>
        </div>
      </div>
