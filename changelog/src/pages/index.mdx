...
As an attempt to be more transparent, we are now reflecting statuses for several parts of our services in a "Status page". The Status page is reachable via our website. The Status page is hosted in an environment separated from all of our other services, it's also served on a separate domain.
