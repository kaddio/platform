...
- New feature: Choose what url to redirect customers to when a contact form has been posted.
- Fix: Added fields show in PDF exports.
- Fix: Page numbers added in letters.
- Fix: Line breaks show correctly in emails.
- Fix: Profile colors show in Booking when customers are logged in to Kaddio.
