...
---
## Kaddio AI (Beta) Released {{ date: '2025-03-10T00:00Z' }}

Kaddio releases it's first official AI tools, now available in beta as an add-on module.

### <SparkleIcon /> AI generated features includes
- Kaddio EMR summaries of entire medical records
- Summaries of entire Chat history per group.
- Get help generating prose for website, available for descriptions and meta-descriptions (for SEO)

Coming soon: Create, share and browse AI prompts via Kaddio Packages.


---
## Ooops {{ date: '2025-03-01T00:00Z' }}

### <SparkleIcon /> New features not reflected
- We forgot to update this changelog with new features since end of 2023 :-| In the coming weeks we will update the changelog to reflect all our latest features.

---
## News {{ date: '2023-10-17T00:00Z' }}

### <SparkleIcon /> New features
- Added alternative to turn off booking confirmations to users by email at bookings by clients or other users. 

---
## News {{ date: '2023-10-02T00:00Z' }}

### <SparkleIcon /> New features
- Forms that are sent to clients now have delivery information. You can see when the form was sent out and by whom, and when the form was filled out by the client.
- Phone numbers are searchable in client lists.
