...
type LayoutRouteId = RouteId | "/" | "/help/sv" | "/help/sv/allmänt/logga-in" | "/help/sv/allmänt/starta-konto" | "/help/sv/hej" | "/hp" | "/hp/en/page/about-us" | "/hp/en/page/career" | "/hp/en/page/environment" | "/hp/en/referral" | "/hp/sv" | "/hp/sv/company/[url]" | "/hp/sv/create" | "/hp/sv/module/cal" | "/hp/sv/module/invoicing" | "/hp/sv/module/log" | "/hp/sv/page/privacy" | "/hp/sv/page/tos" | "/hp/sv/sign-in" | "/hp/sv/support" | "/r/[token]" | null
type LayoutParams = RouteParams & { url?: string,token?: string }
