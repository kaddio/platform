...
<Legal>
    ...
    <LegalUl>
      ...
      <LegalLi>
            <strong class="font-semibold text-gray-900">Correo-e.</strong> Sistemas para el envío automático de correos electrónicos para: facturación, invitación de facultativos y pacientes, recepción de reserva y confirmación de reserva y cancelación. 
