...
<FaqSection>
	...
	<Qa>
		...
		<span slot="a">
			Diseña formularios según tus necesidades. Usa diferentes tipos de respuesta, como texto libre, escala, valor numérico u opción múltiple. Tu eliges cómo Kaddio debe calcular el resultado, por ejemplo, como una suma o un valor promedio. Tu estableces los límites para obtener una vista rápida del resultado.
		</span>
	</Qa>
