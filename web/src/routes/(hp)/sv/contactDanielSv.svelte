	  ...
	  <div class="px-6 lg:px-8">
		<div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
			...
			<p class="mt-6 text-lg leading-8 text-gray-900">
				Kontakta mig så hjälper jag dig. Jag finns oftast tillgänglig på vardagar kl 9 - 15.
			...
			<dl class="mt-10 space-y-4 text-base leading-7 text-gray-900">
			  ...
			  <div class="flex gap-x-4">
				...
				<dd><a class="hover:text-gray-900" href="tel:+46313204414">+46 (0) 31-320 44 14</a></dd>
			  </div>
			  <div class="flex gap-x-4">
				<dt class="flex-none">
				...
				<dd><a class="hover:text-gray-900" href="mailto:sales@kaddio.com">sales@kaddio.com</a></dd>
			  </div>
			</dl>
		</div>
	  </div>
