...
<HeroBox variant="pink">
    <h4>Välkommen till Kaddio!</h4>
    
    I samband med att du skapar ett konto hos oss godkänner du dessa användarvillkor och vår behandling av personuppgifter enligt vad som framgår av vår hemsida kaddio.com.
</HeroBox>

<main>
    <article>
        <h4>Kaddio Användarvillkor</h4>
        <p>
        ...
        <h4>Ändringar i programvaran</h4>
        <p>
        ...
        <h4>Maskinvarukrav</h4>
        
        <p>
            Hårddisk - 500 MB fritt utrymme<br />
            Processor - 1GHz eller snabbare<br />
            Minne - 4 GB<br />
            Internetanslutning - 3G mobilt bredband eller snabbare
        </p>
            
        <h4>Operativsystemskrav</h4>
        <p>
            Du behöver något av följande operativsystem, med angiven eller senare version:<br />
            macOS Sierra - iOS 11.0.2 - Android 8 - Windows 8 - Linux (Ubuntu 16.04, Debian 7) - ChromeOS 60
        </p>
        
        <h4>Webbläsarkrav</h4>
        <p>
            Du behöver någon av följande webbläsare, med angiven eller senare version:<br />
            Safari 11 - Firefox 30 - Chrome 60 - Opera 45			
        </p>
        ...
        <ul>
            <li>Kontaktinformation - namn, adress, e-postadress, telefonnummer m m</li>
            <li>Personnummer</li>
            <li>Betalningsinformation - fakturainformation m m</li>
        ...
        <h4>Ändringar, tillägg och övriga tjänster</h4>
        <p>
        ...
        <h4>Länkar till eller från andra webbplatser</h4>
        <p>
        ...
        <h4>Ansvarsbegränsning, tillämplig lag och tvister</h4>
        <p>
        ...
        <h4>Felanmälan</h4>
        <p>
            Felanmälan görs till support@kaddio.com.<br />
            Felsökning av akuta ärenden som misstänks påverka drift, tillgänglighet eller säkerhet påbörjas inom 2 timmar under supportens öppettider och inom 8 timmar övrig tid.
        </p>
