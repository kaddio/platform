  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto flex max-w-2xl flex-col items-end justify-between gap-16 lg:mx-0 lg:max-w-none lg:flex-row">
      <div class="w-full lg:max-w-lg lg:flex-auto">
        ...
        <p class="mt-6 text-xl leading-8 text-gray-600">If you like being involved, influence and at the same time having a lot of freedom, you will enjoy working with us! We are a small team that works in close collaboration. We only work 6 hour days at our cosy office in central Göteborg, or remotely. We speak Swedish and English and if you have a good sense of rhythm we need a drummer for our office band!</p>
        ...
        <ul class="-my-8 divide-y divide-gray-100">
          ...
          <li class="py-8">
            <dl class="relative flex flex-wrap gap-x-3">
              ...
              <dd class="mt-2 w-full flex-none text-base leading-7 text-gray-600">You will manage and develop our product "Kaddio" that helps 1000+ helath care proffessionals in their daily work. Our stack includes Javascript/typescript, Angular.js, Svelte, Tailwind, Meteor, MongoDB.</dd>
