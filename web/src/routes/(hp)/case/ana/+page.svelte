...
<Legal>
    ...
    <span slot="title">Meet Ana Casanova</span>
    <span slot="subtitle">
      Watch the video to learn about Ana's work and hobbies, and how Kaddio allows for more flexibility in her work with medical records.
    </span>
