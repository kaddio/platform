<div class="relative bg-gray-900">
    ...
    <div class="relative mx-auto max-w-7xl py-24 sm:py-32 lg:py-40 lg:px-8">
      <div class="pr-6 pl-6 md:ml-auto md:w-2/3 md:pl-16 lg:w-1/2 lg:pl-24 lg:pr-0 xl:pl-32">
        ...
        <p class="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">Hantera känsliga uppgifter på ett säkert sätt</p>
        <p class="mt-6 text-base leading-7 text-gray-300">Allting i Kaddio är krypterat. Kaddio har stöd för multifaktorautentisering via Mobilt BankID och engångslösenord via SMS.</p>
        <div class="mt-8">
