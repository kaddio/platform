...
<div class="bg-white">
	...
	<div class="relative isolate overflow-hidden bg-gray-900 pt-14 pb-16 sm:pb-20">
		...
		<div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
			...
			<p class="mt-6 text-lg leading-8 text-gray-300">Kaddio är ett webbaserat allt-i-allo-system för dig som hjälper andra. Kaddio är så enkelt att använda att du knappt behöver tänka när du använder det, den energi kan du lägga på t.ex. dina kunder. Genom att alla funktioner finns i samma enkla system slipper du trötta ut frontalloben i onödan. Din hjärna kommer att älska det.</p>
