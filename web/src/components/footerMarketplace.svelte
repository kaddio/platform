<script>
  ...
  let defaultPlaces = ["Stockholm", "Göteborg", "Malmö","Uppsala","Västerås","Örebro", "Linköping", "Helsingborg"];
</script>
    ...
    <div class="xl:grid xl:grid-cols-3 xl:gap-8">
      ...
      <div class="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
        <div class="md:grid md:grid-cols-2 md:gap-8">
          <div>
            <h3 class="text-sm font-semibold leading-6 text-gray-900">{ $_('För vårdgivare')}</h3>
            <ul class="mt-6 space-y-4">
                <li>
                    <a href="/{lang}/sign-in" class="text-sm hover:underline leading-6 text-gray-600">{ $_('Logga in')}</a>
                  </li>
                  <li>
                    <a href="/{lang}/create" class="text-sm hover:underline leading-6 text-gray-600">{ $_('Skapa konto')}</a>
                  </li>
                  <li>
                    <a href="/about-us" class="text-sm hover:underline leading-6 text-gray-600">{ $_('Om Kaddio')}</a>
                  </li>
                  <li>
                    <a href="/{lang}/support" class="text-sm hover:underline leading-6 text-gray-600">{ $_('Kontakta Kaddio')}</a>
                  </li>

            </ul>
          </div>
          <div class="mt-10 md:mt-0">
            <h3 class="text-sm font-semibold leading-6 text-gray-900">{ $_('Sök plats')}</h3>
            <ul class="mt-6 space-y-4">
                {#each defaultPlaces as place}
                    <li>
                        <a href="/sv/hitta-klinik/Alla/{place}" class="text-sm hover:underline leading-6 text-gray-600">{place}</a>
                    </li>
                {/each}
          </ul>
          </div>
        ...
        <div class="md:grid md:grid-cols-2 md:gap-8">
          <div>
            <h3 class="text-sm font-semibold leading-6 text-gray-900">{ $_('Sökord')}</h3>
            <ul class="mt-6 space-y-4">
                {#each defaultKeywords as keyword}
                <li>
                    <a href="/sv/hitta-klinik/{keyword}" class="text-sm hover:underline leading-6 text-gray-600">{keyword}</a>
                </li>
            {/each}
...
<!--     
    ...
    <div class="mt-8 border-t border-gray/10 pt-8 md:flex md:items-center md:justify-between">
      <div class="flex space-x-6 md:order-2">
        ...
        <!-- <a href="https://www.instagram.com/kaddioapp/" target="_blank" rel="noreferrer" class="text-gray-500">
        ...
        <a href="https://github.com/kaddio" target="_blank" rel="noreferrer" class="text-gray-500">
